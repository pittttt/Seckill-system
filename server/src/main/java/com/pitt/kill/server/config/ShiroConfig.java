...
import com.pitt.kill.server.service.CustomRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean() {
		...
		filterChainDefinitionMap.put("/execute/*", "authc");// 需要认证
		filterChainDefinitionMap.put("/execute/lock", "anon");// 无需认证-压力测试
